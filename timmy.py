...
df_day2 = pd.read_csv('./island-data-bottle-round-1/prices_round_1_day_-2.csv', sep = ';')
df_day1 = pd.read_csv('./island-data-bottle-round-1/prices_round_1_day_-1.csv', sep = ';')
df_day0 = pd.read_csv('./island-data-bottle-round-1/prices_round_1_day_0.csv', sep = ';')
...
df = pd.concat([df_day2, df_day1, df_day0], axis=0)
